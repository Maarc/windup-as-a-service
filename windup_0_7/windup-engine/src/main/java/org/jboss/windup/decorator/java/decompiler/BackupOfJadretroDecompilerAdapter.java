 ...
 * 
 */
public class BackupOfJadretroDecompilerAdapter implements DecompilerAdapter {
	private static final Log LOG = LogFactory.getLog(BackupOfJadretroDecompilerAdapter.class);
